...
if [ $stage = 2 ]; then
    ...
    for dataset_id in 1 2 3 4 5; do
        ...
        python3 script/2_train.py --batch_size ${batch_size} --num_epochs ${num_epochs} --feats_data_path ${feats_data_path} --eval_dataset_id ${dataset_id} --model_name ${model_name}
...
if [ $stage = 3 ]; then
    ...
    for dataset_id in 1 2 3 4 5; do
        ...
        python3 script/3_test.py --batch_size ${batch_size} --feats_data_path ${feats_data_path} --eval_dataset_id ${dataset_id} --model_name ${model_name}
